...
export default function ContainerRecibos() {
  ...
  const [ {receiptsAll,infoReceipts,loading},{getSearchById, getReceiptsByOptions} ] = useReceiptApi(type)
  return (
    <>
    ...
    <div className="table-responsive mb-5">
      <table className="table caption-top table-striped table-hover">
        ...
        {type=== 'celular'&& <TableCelular  type={type} receiptsAll={receiptsAll} loading={loading}/>}
        {type==='freefire'&& <TableFreefire type={type} receiptsAll={receiptsAll} loading={loading}/>}
        {type==='pines'&& <TablePines type={type} receiptsAll={receiptsAll} loading={loading}/>}
